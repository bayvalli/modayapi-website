        ...
        <div className="grid grid-cols-12 gap-gutter mb-block-gap">
          <div className="col-span-12 lg:col-span-9 flex flex-col gap-6">
            ...
            >
              ...
              {imageLoading && (
                <div className="absolute inset-0 bg-[#121212] flex flex-col justify-center items-center text-center p-6 z-10">
                  <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff07_1px,transparent_1px),linear-gradient(to_bottom,#ffffff07_1px,transparent_1px)] bg-[size:32px_32px]"></div>
                  <div className="relative mb-6">
                    <div className="w-14 h-14 border-4 border-dashed border-white/25 animate-spin rounded-full"></div>
...
const FloorPlansContainer: React.FC<{ floorPlans: FloorPlan[] }> = ({ floorPlans }) => {
  ...
  const renderRoomInterior = (room: BlueprintRoom) => {
