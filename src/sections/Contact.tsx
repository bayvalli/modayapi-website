...
export const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="w-full max-w-[1440px] mx-auto px-margin pt-block-gap pb-block-gap overflow-hidden">
      {/* Header Section */}
      ...
      <div className="grid grid-cols-12 gap-gutter relative">
        ...
        <div className="col-span-12 md:col-span-5 md:col-start-1 h-[600px] bg-secondary-container border-2 border-primary relative z-0 mb-asymmetric md:mb-0 overflow-hidden">
          {!hasValidKey ? (
            <div className="w-full h-full p-8 flex flex-col items-center justify-center text-center bg-surface-container font-sans">
              <h3 className="text-headline-sm text-primary mb-4">Google Maps API Anahtarı Gerekli</h3>
              <p className="text-body-md text-secondary mb-6 max-w-xs">Haritayı görüntülemek için lütfen GOOGLE_MAPS_PLATFORM_KEY anahtarını ayarlara ekleyin.</p>
        ...
        <div className="col-span-12 md:col-span-4 md:col-start-7 z-10 mt-asymmetric flex flex-col gap-12">
          <div className="border-t-4 border-primary pt-6">
            <h3 className="font-label-caps text-secondary mb-2 tracking-widest uppercase">Merkez Ofis</h3>
          ...
          <div className="border-t-4 border-primary pt-6">
            <h3 className="font-label-caps text-secondary mb-2 tracking-widest uppercase">İrtibat</h3>
            <p className="text-body-lg text-primary font-sans">
              +90 532 311 82 10<br />
              info@modayapi.com
            </p>
          ...
          <div className="border-t-4 border-primary pt-6">
            ...
            <div className="flex flex-col gap-2">
              <a href="https://www.instagram.com/modayapias?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="font-serif text-headline-md text-primary hover:text-secondary transition-colors underline decoration-2 underline-offset-4 uppercase">Instagram</a>
            </div>
          </div>
        </div>
      </div>
          ...
          {submitted ? (
            <div className="flex flex-col text-left py-4">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-mono text-xs uppercase tracking-widest text-emerald-600 font-bold">Transaksiyon Başarılı</h3>
              </div>
              <h2 className="font-serif text-headline-md text-primary mb-8 uppercase leading-tight">MESAJINIZ ALINDI.</h2>
              ...
              <div className="bg-surface border-2 border-primary p-6 font-mono text-xs space-y-4 mb-8">
                ...
                <div className="flex justify-between pb-1">
                  ...
                  <span className="font-bold px-2 py-[2px] bg-primary text-on-primary">MÜHENDİS_ONAYI_BEKLİYOR</span>
                </div>
              </div>

              <p className="text-body-md text-secondary mb-8 font-sans">
                Mesajınız teknik veri tabanımıza kaydedildi. Mühendislerimiz projeyi inceledikten sonra en kısa sürede sizinle iletişime geçecektir.
              </p>
            ...
            <>
              <h2 className="font-serif text-headline-md text-primary mb-12 uppercase">Mesaj Bırakın</h2>
              <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
                <div className="flex flex-col relative group">
                  <label className="font-label-caps text-secondary mb-2 uppercase tracking-widest text-xs">Ad Soyad</label>
                  <input 
                ...
                <div className="flex flex-col relative group">
                  <label className="font-label-caps text-secondary mb-2 uppercase tracking-widest text-xs">E-posta</label>
                  <input 
                    className="w-full bg-transparent border-0 border-b-2 border-primary px-0 py-2 text-body-lg text-primary focus:ring-0 focus:border-b-4 focus:border-primary transition-all outline-none" 
                    type="email" 
                    required
                ...
                <div className="flex flex-col relative group mb-8">
                  <label className="font-label-caps text-secondary mb-2 uppercase tracking-widest text-xs">Proje Detayı</label>
                  <textarea 
                ...
                <button 
                  ...
                  className={`w-full border-4 border-primary bg-surface py-6 font-serif text-headline-md text-primary transition-colors duration-300 uppercase ${
                    isSubmitting ? 'opacity-50 cursor-not-allowed bg-primary/5' : 'hover:bg-primary hover:text-on-primary'
                  }`} 
                  type="submit"
                >
