        ...
        <div className="grid grid-cols-12 gap-gutter mt-block-gap">
          <div className="col-span-12 md:col-span-6 md:col-start-2">
             <div className="bg-surface border-heavy p-12 -mt-32 md:-mt-64 relative z-30">
                <h3 className="text-headline-lg mb-8 leading-tight">Köklü Geçmiş, <br/>Yenilikçi Gelecek.</h3>
                <p className="text-body-lg text-on-surface mb-8">
                  ...
                  faaliyet gösteren köklü bir yapıya dönüşmüştür. Sağlam temeller üzerine inşa ettiğimiz 
                  vizyonumuzla, sadece binalar değil, geleceğin yaşam alanlarını ve dijital altyapılarını tasarlıyoruz.
                </p>
                
                <div className="space-y-6">
                   <div className="border-b-2 border-primary pb-4">
                      <h4 className="text-headline-md leading-none mb-2">1960</h4>
                      <span className="font-label-caps text-secondary text-xs uppercase">Kiremit üretimi ve inşaat malzemesi Satışı</span>
                   </div>
                   <div className="border-b-2 border-primary pb-4">
                      <h4 className="text-headline-md leading-none mb-2">1980</h4>
                      <span className="font-label-caps text-secondary text-xs uppercase">Aile Şirketi olan Ayvallı İnşaat Ltd. Şti.'nin kuruluşu</span>
                   </div>
                   <div className="border-b-2 border-primary pb-4">
                      <h4 className="text-headline-md leading-none mb-2">1999</h4>
                      <span className="font-label-caps text-secondary text-xs uppercase">Perakende kömür satışı faliyetinin eklenmesi</span>
                   </div>
                   <div className="border-b-2 border-primary pb-4">
                      <h4 className="text-headline-md leading-none mb-2">2017</h4>
                      <span className="font-label-caps text-secondary text-xs uppercase">Yeni bir kimlik ile inşaat sektörüne adım atılması ve Moda Yapı'nın kuruluşu</span>
                   </div>
                   <div className="border-b-2 border-primary pb-4">
                      <h4 className="text-headline-md leading-none mb-2">2025</h4>
                      <span className="font-label-caps text-secondary text-xs uppercase">Dijital dönüşüm ve yazılım</span>
                   </div>
                </div>
             </div>
          </div>
