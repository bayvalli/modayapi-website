    ...
    <section id="projects" className="py-block-gap">
      <div className="max-w-[1440px] mx-auto px-margin">
        <header className="mb-block-gap flex flex-col md:flex-row justify-between items-end gap-gutter">
          <h2 className="text-headline-xl text-primary leading-none">
            İNŞAAT
            <br />
            KALİTESİ
          </h2>
          <div className="md:w-1/3 border-b-4 border-primary pb-4">
            <p className="text-body-md text-secondary lowercase">
              Güvenilir, dayanıklı ve modern mühendislik standartlarında inşa edilmiş seçkin taahhüt
              projelerimiz.
            </p>
          </div>
        </header>
              ...
              >
                ...
                >
                  <Link
                    ...
                    className="block aspect-[16/9] border-heavy bg-surface-container overflow-hidden group relative cursor-pointer"
                  >
                    <img
                ...
                <div
                  className={`col-span-12 md:col-span-5 bg-surface border-heavy p-8 md:p-12 z-20 shadow-none mt-8 md:mt-0 md:row-start-1 md:self-center ${isEven ? 'md:col-start-8' : 'md:col-start-1'}`}
                >
                  <span className="font-label-caps text-secondary mb-4 block uppercase">
                    {project.category}
                  </span>
                  <h3 className="text-3xl sm:text-4xl md:text-headline-lg text-primary mb-6 leading-tight break-words">
                    {project.title}
                  </h3>
